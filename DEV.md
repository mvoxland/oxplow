...
Subsystem docs live under [`.context/`](./.context/) and are mid-port
post-rewrite — paths inside still reference the old `src/electron`
layout in places. The corresponding new locations are listed above.
